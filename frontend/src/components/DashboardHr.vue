      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div class="text-center mb-3">
            <Button @click="applyDate" class="min-h-[2.75rem] bg-green-500 hover:bg-green-600 text-white focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 active:scale-95 transition-transform duration-150">
              Apply
            </Button>
          </div>
        </div>
