<template>
  ...
  <div class="relative flex flex-col min-h-screen bg-gray-900 text-white">
    ...
    <!-- Spline 3D Animation en arrière-plan -->
    <spline-viewer
      id="splineViewer"
      url="https://prod.spline.design/HrUvzViadg-5Zjme/scene.splinecode"
      class="absolute inset-0 z-0"
    ></spline-viewer>

    <!-- Contenu principal (formulaires) au premier plan -->
    <div class="relative z-10 flex flex-col items-center justify-center p-6 bg-gray-900 bg-opacity-80 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-20">
      <!-- gotham Image -->
...
<style scoped>
/* CSS pour ajuster le fond de la scène Spline */
#splineViewer {
  width: 100%;
  height: 100%;
  position: absolute;
  ...
  left: 0;
  z-index: 0;
  pointer-events: none; /* Désactive les interactions pour l'arrière-plan */
}

/* CSS pour ajuster le formulaire */
.relative {
